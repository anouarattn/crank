...
Start a discussion on the [repository issue tracker](https://github.com/dotnet/crank/issues).
...
If you don't know what a pull request is read this article: https://help.github.com/articles/using-pull-requests. Make sure the repository can build and all tests pass. Familiarize yourself with the project workflow and our coding conventions, which are the same as the ASP.NET ones. The coding, style, and general engineering guidelines are published on the [ASP.NET Engineering guidelines](https://github.com/dotnet/aspnetcore/wiki/Engineering-guidelines) page.
